    ...
    <div className="max-w-4xl mx-auto px-4">
      ...
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-3xl p-10 text-center mb-16">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-[var(--text)] font-bold px-8 py-4 rounded-full transition-all hover:scale-105 text-sm tracking-wider"
        >
